			...
			transporter.sendMail({
				...
				html: `
						...
						<td align="left" valign="middle"> 
							<img src="https://lh3.googleusercontent.com/-VTs6GEhLon4/WMA7Fo5sSwI/AAAAAAAAEtY/dAZAoAGwjSMS79ITFsJiG3Mqb5wcmSYewCEwYBhgL/w140-h139-p/IMG_6983.JPG" width="50" height="50" style="border:0;width:51px;height:50px" class="CToWUd">
						</td> 
						...
						<tbody> 
						<tr> 
						<td> <h1 style="font-family:'Open Sans',-apple-system,Helvetica,Arial,sans-serif!important;font-weight:600;margin:25px 20px 25px 20px;padding:0px;text-align:center;color:#282828;font-size:20px">HANUMANTHNBALU</h1> 
						</td> 
						</tr> 
						</tbody> 
						</table> </td> 
				...
				`
				// html: `<div style="background: #da1d22;text-align:center;padding:20px;border-radius:10px;width:70%;border:1px solid #cdcdcd;margin:0 auto;color: #110e0e;">	<div style="width: 100%;margin: 0 auto;display: block;"> 
				// <img style="box-shadow: 0 8px 29px 2px rgba(66, 66, 66, 0.8);border-radius: 100px;" src="https://lh3.googleusercontent.com/-VTs6GEhLon4/WMA7Fo5sSwI/AAAAAAAAEtY/dAZAoAGwjSMS79ITFsJiG3Mqb5wcmSYewCEwYBhgL/w140-h139-p/IMG_6983.JPG" alt="Logo">
				// </div>
				// <strong style="color:#66cb86;padding: 10px 0px;font-weight: 900;">Hi, ${user.username}</strong>
				// <h1>Welcome to HNBALU</h1>
				// <p>User Details:</p>
